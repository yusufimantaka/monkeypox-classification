...
\author{
    \IEEEauthorblockN{Yusuf Imantaka Bastari}
    \IEEEauthorblockA{
    ...
    \and
    \IEEEauthorblockN{Aufa Sultan Syach Majid Putra Yuliyanto}
    \IEEEauthorblockA{
        \textit{Department of Computer Science and Electronics} \\
        \textit{Universitas Gadjah Mada} \\
        Yogyakarta, Indonesia \\
        johndoe@mail.ugm.ac.id
    }
}
...
\centering
\small
\begin{tabular}{@{}p{1.7cm}p{5.2cm}c@{}}
\toprule
...
Color & Moments (mean, std, CV) in BGR, HSV, LAB & 27 \\
      ...
      & HSV percentiles (5th, 50th, 95th) & 9 \\
\midrule
...
\midrule
Texture (Gabor)& Mean and std of Gabor magnitude (3 orientations $\times$ 2 scales) & 12 \\
\midrule
...
\centering
\small
\begin{tabular}{@{}p{2.6cm}p{2.4cm}cccc@{}}
\toprule
\textbf{Feature Set} & \textbf{Classifier} & \textbf{Acc.} &
\textbf{F1 (macro)} & \textbf{Test AUC} & \textbf{CV AUC} \\
\midrule
...
Hybrid (full) & Logistic Reg. & 0.812 & 0.808 & 0.885 & 0.896 \\
...
Handcrafted & Logistic Reg. & 0.667 & 0.666 & 0.778 & 0.763 \\
...
at Universitas Gadjah Mada. The authors thank the creators of the
publicly available Monkeypox Skin Lesion Dataset on Kaggle for
